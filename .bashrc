...
DEV_INTE=AWSPowerUserAccess-159851557642
UTS_SANDPIT=046955552049--UTS-AWS-Sandpit
BINARIES=/usr/local/bin

################################################################################
# CUSTOM ALIASES FOR MW ######################################################## 
################################################################################

alias __EDIT__="gvim ~/.bashrc"
...
alias __BINARIES__=/usr/local/bin/
alias __CD_BINARIES__="cd /usr/local/bin/"
...
__GETLOG() {
	...
	gvim ~/Downloads/logs_$1/*/*Apply.txt
